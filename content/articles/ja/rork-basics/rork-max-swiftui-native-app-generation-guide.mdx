...
author: "Rork Lab"
description: "Rork Maxで自然言語からSwiftUIのネイティブiOSアプリを生成する仕組みと活用法を中級者向けに解説します。実践手順、生成コードのカスタマイズとトラブルシューティング、App Store申請前の最終確認、収益化の判断材料までを扱います。通常プランとの違いも整理します。"
...
<table>
  ...
  <tbody>
    ...
    <tr><td>API 呼び出しが失敗する</td><td>ネットワーク設定</td><td>Info.plist に <code>NSExceptionDomains</code> を追加</td></tr>
