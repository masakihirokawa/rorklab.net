...
ここでは[Rork AI](/articles/rork-basics/what-is-rork) を使ってレシピ管理アプリをゼロから構築する方法を、プロンプト設計の段階から順を追ってご紹介します。プログラミング経験がなくても大丈夫です。Rork のAIアシスタントがコード生成を担当してくれるので、アイデアと設計に集中できます。
