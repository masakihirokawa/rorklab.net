...
author: "Rork Lab"
description: "Rorkでポモドーロタイマーアプリを作るチュートリアルです。タイマーのコアロジック、セッション管理、円形プログレスバー、通知とフィードバックの実装までを6つのStepで解説します。状態管理の基本を学びたい初心者の方にも向いた、25分集中と5分休憩のサイクルを形にする題材です。"
...
- **タスクリスト連携**: 作業セッションごとにタスクを紐づけて、何に集中したかを記録します。タスク管理の基本は[ToDoアプリのチュートリアル](/articles/rork-basics/build-todo-app)を参考にしてください。
