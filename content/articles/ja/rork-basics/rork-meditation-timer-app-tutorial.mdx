...
author: "Rork Lab"
description: "Rorkで瞑想タイマーアプリを作る初心者向けの入門です。画面構成の設計から、カウントダウンタイマー、環境音の再生、セッション履歴の保存と表示までを一つずつ実装し、マインドフルネスアプリらしいUI/UXに仕上げるポイントも紹介します。ヘルスケア分野の開発入門としても最適です。"
...
<table>
  <thead>
    <tr><th>用途</th><th>カラー</th><th>説明</th></tr>
  </thead>
  <tbody>
    <tr><td>背景</td><td><code>#0D1B2A</code></td><td>深いネイビー</td></tr>
    <tr><td>メインテキスト</td><td><code>#E0E1DD</code></td><td>柔らかいホワイト</td></tr>
    <tr><td>アクセント</td><td><code>#415A77</code></td><td>落ち着いたブルー</td></tr>
    <tr><td>プログレスリング</td><td><code>#778DA9</code></td><td>ライトブルーグレー</td></tr>
    <tr><td>ボタン（開始）</td><td><code>#1B9AAA</code></td><td>ティールグリーン</td></tr>
  </tbody>
</table>
