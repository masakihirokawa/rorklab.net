...
author: "Rork Lab"
description: "Rorkでマッチングアプリの核となる機能を作るチュートリアルです。いいねとスキップのスワイプUI、Supabaseを使ったマッチング判定、リアルタイムチャット、プロフィール画像のアップロードまで、よくあるエラーの対処も交えて実装します。コーディング経験が浅くても進められる構成です。"
