---
title: "Rorkでメモアプリを作る — AsyncStorage による永続化と検索の実装"
...
author: "Rork Lab"
description: "Rorkでメモアプリをゼロから組み立てるチュートリアルです。AsyncStorageによるデータ永続化、useMemoを使ったリアルタイム検索、カテゴリ分類、デザインを磨く実践テクニックまで、動くコードを追いながら5つのステップで進めます。最初の一本に向いている理由から説明します。"
...
構造がはっきりしていて、それでいて「保存」「一覧」「検索」というアプリ開発の基本要素が一通り詰まっている。だからメモアプリは、**Rork** で最初に作る題材として扱いやすいのです。ここからゼロの状態を出発点に、AsyncStorage への永続化と検索まで一本のアプリに仕上げていきます。
