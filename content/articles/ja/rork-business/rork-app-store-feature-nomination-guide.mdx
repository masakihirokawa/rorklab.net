...
`App Store Connect → マイ App → 特定アプリ → App Store → 販促情報` から「イベント」や「プロモーション依頼」のフォームにアクセスできます。また、Apple Developer Program のメンバーは [developer.apple.com](https://developer.apple.com/contact/app-store/promote/) からフィーチャー申請が可能です。
