...
author: "Rork Lab"
description: "Google Stitchで生成したUIデザインをRork Maxへ取り込み、React Nativeアプリを最短で仕上げるワークフローです。基本の連携手順、MCPによる効率化、タスク管理アプリでの実践例、効果的なケースと注意点までを一通り解説します。デザインから実装への変換コストを下げます。"
