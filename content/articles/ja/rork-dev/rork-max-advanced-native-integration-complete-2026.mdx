...
author: "Rork Lab"
description: "Rork MaxでiOSとAndroidのネイティブ機能を統合する本番対応ガイドです。HealthKit、CameraX、ARKitとARCore、NFC決済とタグ読み取りの実装、パーミッション管理のベストプラクティス、メモリリーク対策までを体系的に解説します。高付加価値アプリへの近道です。"
