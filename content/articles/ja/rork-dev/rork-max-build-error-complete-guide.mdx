---
title: "Rork Max のビルドが通らないとき — SwiftUI・Expo Router・ネイティブモジュール連携の切り分け手順"
...
author: "Rork Lab"
description: "Rork Maxのビルドが通らないときの切り分け手順です。エラーログの最初の1行に立ち返る基本から、SwiftUIコンポーネント生成時のエラー、Expo Routerの互換性、ネイティブモジュール連携、iOSとAndroidそれぞれの固有問題までを体系的に解説します。"
