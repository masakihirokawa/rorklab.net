...
author: "Rork Lab"
description: "TestFlightでは動いたRorkアプリがApp Store公開後にクラッシュする原因を4パターンに整理します。本番ビルドで環境変数がundefinedになる、ATSの厳格適用、プライバシーマニフェストの申告漏れ、メモリ不足への対処と、Sentry導入による把握までを解説します。"
