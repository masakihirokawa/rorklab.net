...
React のコンカレント機能と AbortController の組み合わせは、[『りあクト！ TypeScriptで始めるつかえるReact 第5部』（大岡由佳）](https://www.amazon.co.jp/dp/B0CG7DJVG5/?tag=pinocchio-22) でも触れられています。useTransition と組み合わせると検索結果のチラつきがさらに抑えられます。
