...
author: "Rork Lab"
description: "Rorkで本番リリースするアプリに必要なセキュリティ実装をまとめます。expo-local-authenticationによる生体認証、セキュアストレージ、JWTトークン管理、AES-256暗号化、証明書ピンニング、ルート検出までを実践コード付きで解説します。審査落ちや流出事故を防ぐ土台になります。"
