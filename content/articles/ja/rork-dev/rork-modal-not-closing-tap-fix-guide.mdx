...
author: "Rork Lab"
description: "Rorkで生成したReact NativeのModalが閉じない、背景タップに反応しない問題の直し方です。transparentとonRequestCloseの指定漏れ、KeyboardAvoidingViewとの組み合わせ、FlatList内配置、入れ子Modalなど詰まりやすい5つの落とし穴を整理します。"
