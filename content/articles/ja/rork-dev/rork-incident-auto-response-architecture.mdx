...
<table>
  <thead>
    <tr><th>層</th><th>一次データソース</th><th>二次データソース</th><th>通知優先度</th></tr>
  </thead>
  <tbody>
    <tr><td>クラッシュ層</td><td>Firebase Crashlytics</td><td>Sentry</td><td>Critical（即時）</td></tr>
    <tr><td>機能層</td><td>Sentry（Performance + Error）</td><td>Firebase Performance</td><td>High（5 分以内）</td></tr>
    <tr><td>収益層</td><td>AdMob API + RevenueCat</td><td>Firebase Analytics</td><td>Medium（30 分以内）</td></tr>
  </tbody>
</table>
