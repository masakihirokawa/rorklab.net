...
author: "Rork Lab"
description: "RorkアプリのAI機能をCloudflare ContainersとWorkers AIでどう使い分けるかを解説します。まずWorkers AIで済むかを疑う判断、Containersを選ぶ3つの局面、最小構成での呼び出し、実際のコスト感覚、運用で分かった落とし穴まで具体的に扱います。"
