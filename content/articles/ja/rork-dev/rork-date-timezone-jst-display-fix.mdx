...
author: "Rork Lab"
description: "Rorkで作ったアプリの日時が9時間ずれる、深夜に日付が変わるといったタイムゾーン問題の直し方です。UTC文字列の扱い、AsyncStorage保存で文字列化する罠、iOSとAndroidで挙動が違うnew Dateの落とし穴を5つのパターンで整理し、ライブラリ選びの指針も述べます。"
