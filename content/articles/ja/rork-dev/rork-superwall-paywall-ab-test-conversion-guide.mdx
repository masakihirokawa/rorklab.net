...
author: "Rork Lab"
description: "Rorkで開発したサブスクアプリにSuperwallを導入し、ペイウォールのA/Bテストで課金転換率を高める方法です。ExpoプロジェクトへのSDK導入、placementの使い方、RevenueCatとのPurchaseController連携、ダッシュボードでのテスト設定と分析までコード付きで紹介します。"
