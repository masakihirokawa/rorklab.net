...
<table>
  <thead>
    <tr><th>取りこぼし状況</th><th>担当する層</th></tr>
  </thead>
  <tbody>
    <tr><td>アプリ完全終了中の更新請求</td><td>第一層: 起動時の <code>currentEntitlements</code> 再評価</td></tr>
    <tr><td>ネットワーク不調・バックグラウンド長時間</td><td>第二層: Background App Refresh による定期照合</td></tr>
    <tr><td>端末移行・iCloud 同期遅延</td><td>第三層: Restore Purchase の手動トリガ</td></tr>
  </tbody>
</table>
