...
Rork Max は[クラウド Mac フリート](/articles/rork-dev/rork-max-2-click-publish-complete-guide)でビルドするため、ローカルに Xcode は不要です。ブラウザから [rork.com/max](https://rork.com/max) にアクセスし、新しいプロジェクトを作成します。
