...
author: "Rork Lab"
description: "Rork MaxでHealthKit・Apple Watch・ホーム画面ウィジェットを統合したフィットネストラッカーを構築する上級チュートリアルです。3つのAppleフレームワークを横断する設計思想からステップ実装、応用パターン、App Store公開と収益化のポイントまで扱います。"
