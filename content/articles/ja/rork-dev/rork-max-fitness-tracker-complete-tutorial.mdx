...
Rork Max を使えば、これら3つのフレームワークを**自然言語プロンプト**で統合したアプリを構築できます。iPhone アプリ・Apple Watch コンパニオンアプリ・ホーム画面ウィジェットを1つのプロジェクトとして設計・実装し、App Store に公開するまでの全工程を順を追って整理していきます。
