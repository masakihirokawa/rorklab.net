...
author: "Rork Lab"
description: "RorkアプリがiOSでは動くのにAndroidだけ崩れる問題を、5つの代表的な差異から解決します。シャドウが表示されない、フォントの太字が効かない、ステータスバーの高さ、権限取得の違い、キーボードが入力欄を隠す症状を実例コードで修正します。Android実機で先に試す習慣も勧めます。"
