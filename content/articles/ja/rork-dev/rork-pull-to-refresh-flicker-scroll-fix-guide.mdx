...
author: "Rork Lab"
description: "Rorkで生成したアプリのPull to Refreshで画面がチラつく、スクロール位置が飛ぶ、読み込みが終わらない症状を解消します。RefreshControlとScrollViewの関係の理解から、keyExtractorの安定化、ネストしたスクロールの競合回避まで実装パターンで直します。"
