---
title: "Rork で expo start --offline 時に validateDependenciesVersions forbidden が出る原因と確実な解消手順"
...
author: "Rork Lab"
description: "Rork で生成したプロジェクトをローカルで expo start --offline すると EXPO_OFFLINE=1 と validateDependenciesVersions=false を組み合わせた瞬間に forbidden エラーで落ちる現象を、Expo CLI のバリデーション仕様と Rork のテンプレ構成の交差点で説明し、確実に通る手順を整理しました。"
