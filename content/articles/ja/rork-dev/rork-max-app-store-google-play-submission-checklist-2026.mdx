...
author: "Rork Lab"
description: "Rork Maxで作ったアプリをApp StoreとGoogle Playに申請する前の確認事項をチェックリスト化しました。React Native特有の問題とAI生成コードに起きやすい問題の両方をカバーし、リジェクトを防ぐための実践的なポイントと申請後によくある疑問も扱います。"
