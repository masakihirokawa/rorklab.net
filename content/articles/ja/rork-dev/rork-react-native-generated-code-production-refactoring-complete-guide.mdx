...
highlights:
  - "Rorkが生成するコードに特有の6つの技術的負債パターンを特定できるようになり、本番リリース前に確実に解消できる"
  - "TypeScript型安全化・コンポーネント分離・状態管理の3段階リファクタリング手順を完全なBefore/Afterコード例とともに習得できる"
  - "リリース後も機能追加・チームメンバーの参加・スケールに耐えられる持続可能なアーキテクチャを自分で設計できるようになる"
---
