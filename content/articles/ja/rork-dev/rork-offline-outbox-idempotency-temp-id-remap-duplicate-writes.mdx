...
noindex: true
author: "Rork Lab"
description: "オフラインで書いた投稿が復帰時に二重登録される問題を防ぐ、送信アウトボックスの設計です。生成時に一度だけ決める冪等キー、SQLiteへの永続化、一時IDの付け替え、毒メッセージの隔離までを、動くTypeScriptコードとともに組み立てます。再送だけでは安全にならない理由から説明します。"
