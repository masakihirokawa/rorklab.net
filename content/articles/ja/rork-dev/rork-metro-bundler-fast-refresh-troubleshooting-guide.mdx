...
author: "Rork Lab"
description: "Rorkで生成したExpoアプリでMetro bundlerが固まる、Fast Refreshが反映されないときの診断手順です。最初に確認すべき3つのシグナル、キャッシュやWatchmanなど代表的な原因、症状別フローチャート、安全な順序で実行する完全リセットのコマンド集をまとめました。"
