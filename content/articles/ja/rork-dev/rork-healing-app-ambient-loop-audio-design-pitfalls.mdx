...
author: "Rork Lab"
description: "癒し・瞑想系アプリのアンビエントサウンド実装でRorkが苦手な3つのパターンを解説。ループ途切れ・iOSサイレントモード・バッテリー消耗の問題をexpo-avで解決する実践コード付き。"
...
癒し系アプリでよくあるシナリオです。ユーザーが「寝る前に使いたい」と思っているのに、着信音スイッチをオフにしていると音が一切聞こえない。AppStoreのレビューにも「BGMが聞こえない」というコメントが来やすい問題です。
...
「途切れなし」「サイレントモードでも再生」という言葉をプロンプトに入れるだけで、Rorkの生成コードの質が変わります。AIに何をしてほしいかではなく、何を避けてほしいかを伝えることが重要です。
