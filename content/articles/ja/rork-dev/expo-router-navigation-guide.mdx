...
Rorkで生成されたReact Native / Expoアプリには、**Expo Router**というファイルベースのルーティングシステムが採用されています。ナビゲーション設計はアプリのUXを左右する最重要要素のひとつ。Expo Routerの仕組みを理解しながら、タブ・スタック・ドロワーの各ナビゲーションパターンをRorkで正しく実装する方法を順を追って整理していきます。
