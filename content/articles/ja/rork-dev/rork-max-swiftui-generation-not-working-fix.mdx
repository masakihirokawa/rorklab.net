---
title: "Rork Max で SwiftUI が生成されない・ビルドが通らないときの切り分け"
...
author: "Rork Lab"
description: "Rork Max で SwiftUI ネイティブ機能が生成されない、ビルドが通らない。原因はプラン設定・プロンプト・依存関係の3つに絞り込めます。切り分けの順番と、実際に通るプロンプトの書き方をまとめました。"
