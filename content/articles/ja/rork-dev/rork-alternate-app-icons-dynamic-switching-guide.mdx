...
---
プレミアム会員になった瞬間にアプリアイコンが特別なデザインに切り替わる、季節限定のアイコンを期間中だけ出し分ける、ダークモード好きな人だけ別の配色を選べるようにします。こうした「アプリ内からアイコンを動的に切り替える」機能を Rork で組み込もうとしたとき、Expo SDK 標準の `expo-image` や `expo-router` を眺めていても答えが見つからず、半日詰まりました。
