...
ちなみに本番運用全般の考え方技術書籍の [Site Reliability Engineering（Betsy Beyer 編）](https://www.amazon.co.jp/dp/4873117917/?tag=pinocchio-22) の SRE 全体像を扱う章が、個人開発者にとっても運用思想の解像度を上げてくれます。Google のサービス向けに書かれた内容ですが、SLO・エラーバジェット・ポストモーテムの考え方は、規模を問わず通用すると感じています。
