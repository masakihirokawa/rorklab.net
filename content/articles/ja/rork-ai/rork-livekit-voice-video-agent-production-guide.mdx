...
author: "Rork Lab"
description: "LiveKit AgentsをRork製のReact Nativeアプリに組み込み、低遅延のAI音声エージェントを本番運用するための設計ガイドです。Agentサーバーとトークン発行APIの実装、クライアント側の組み込み、収益化の設計、コスト試算と損益分岐まで章立てで解説します。"
