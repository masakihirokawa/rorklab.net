...
2014年からiOSアプリを作り続けてきた私は、壁紙アプリや瞑想タイマーを経て、日替わりタロット占いアプリを個人開発しました。そのときの経験から言えるのは、「占いアプリは見た目よりずっと複雑」だということです。Rorkを使えば多くの部分は解決できますが、占いというジャンル固有の設計上の注意点があります。この記事では、実際につまずいた7つのポイントを中心に解説します。

## なぜ占いアプリは難しいのか

一見シンプルに見えます。カードを引いて、意味を表示する。それだけでは？
