...
<table>
  <thead>
    <tr><th>ツール</th><th>月額</th><th>用途</th><th>削減効果</th></tr>
  </thead>
  <tbody>
    <tr><td>Copilot Pro+</td><td>USD 39</td><td>CLI + Agent + PR Review</td><td>Issue → PR 自動化で 5 時間削減</td></tr>
    <tr><td>Rork（App プラン）</td><td>JPY 4,900</td><td>UI + 初期実装</td><td>設計フェーズを 3 日短縮</td></tr>
    <tr><td><strong>合計</strong></td><td><strong>JPY ~9,000</strong></td><td>単一アプリ</td><td>—</td></tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr><th>項目</th><th>Copilot + Rork</th><th>Claude Code のみ</th></tr>
  </thead>
  <tbody>
    <tr><td>トークン消費（月）</td><td>~200K</td><td>~800K</td></tr>
    <tr><td>月額コスト</td><td>JPY 9,000</td><td>JPY 15,000</td></tr>
    <tr><td>開発日数</td><td>14 日</td><td>21 日</td></tr>
  </tbody>
</table>
...
対策：**Rork 生成後、すぐに Copilot CLI での細部実装に移行**します。その間、Copilot Agent を一時停止します。
