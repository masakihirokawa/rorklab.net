...
<table>
  <thead>
    <tr><th>Model</th><th>Use Case</th><th>Implementation</th></tr>
  </thead>
  <tbody>
    <tr><td><strong>One-time Charge</strong></td><td>Upgrade to paid, add-on features</td><td>★☆☆</td></tr>
    <tr><td><strong>Subscription</strong></td><td>Recurring monthly/yearly billing</td><td>★★☆</td></tr>
    <tr><td><strong>Usage-Based</strong></td><td>Dynamic pricing per API calls, storage</td><td>★★★</td></tr>
  </tbody>
</table>
