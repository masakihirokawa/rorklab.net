---
title: "What Rork's $15M Round Reveals About Launching in the AI Era"
...
noindex: true
author: "Rork Lab"
description: "How Rork went from $2.8M to $15M — and what it chose not to do along the way. A breakdown of PMF discovery, App Store strategy, marketing tactics, and revenue design at a resolution you can act on."
...
The number worth studying isn't the $15M. It's the sequence of decisions underneath it — what Rork bet on first, what it deliberately left alone, and how far a solo developer can retrace the same path. Below, those decisions get taken apart one at a time.
