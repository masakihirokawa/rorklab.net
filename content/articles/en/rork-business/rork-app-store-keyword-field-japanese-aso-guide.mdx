...
Here are the keyword-field mistakes I keep seeing on indie listings, each paired with the fix:

- **Repeating app-name words in the keyword field** → Delete the duplicates and spend the freed characters on autocomplete-derived terms.
- **Spaces after commas** → Strip every space and re-pack. This alone often buys you an extra keyword or two.
- **Only one script or spelling for a term** → In non-Latin markets especially, add one or two spelling variants for your most important words.
- **Reusing one keyword field across every locale** → Redesign at least your top two or three locales individually.
- **Swapping words with no measurement** → Save before/after lists in a spreadsheet and check them against your impression trend in Analytics.

None of these take more than an evening to fix, and they compound quietly over time.
...
If you want to take ASO further, [Making a Rork App Sell on the App Store](/articles/rork-business/rork-app-store-aso-pricing-iap-strategy) covers the broader picture, and [Global ASO in 16 Languages](/articles/rork-business/global-aso-16-languages-strategy) extends the same thinking to international markets. For the post-launch growth phase, [Rork: From Launch to Your First $1,000](/articles/rork-business/rork-first-revenue-launch-playbook) picks up where keyword design leaves off.
