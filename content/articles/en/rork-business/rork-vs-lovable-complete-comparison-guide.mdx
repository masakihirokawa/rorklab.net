...
<table>
  <thead>
    <tr><th>Item</th><th>Rork</th><th>Lovable</th></tr>
  </thead>
  <tbody>
    <tr><td>Free tier</td><td>Trial-only</td><td>A few messages per day</td></tr>
    <tr><td>Personal</td><td>From ~$20/mo</td><td>From ~$25/mo</td></tr>
    <tr><td>Higher tier</td><td>$100+/mo (Pro / Max)</td><td>$100+/mo</td></tr>
    <tr><td>Credit system</td><td>Yes (per message)</td><td>Yes (per message)</td></tr>
    <tr><td>Export</td><td>Full code via GitHub</td><td>Full code via GitHub</td></tr>
  </tbody>
</table>
