...
**Format mix.** My optimal mix on the wallpaper apps (such as [Beautiful Wallpapers](https://play.google.com/store/apps/details?id=net.dolice.beautifulwallpapers)) was banner (always-on at the bottom of home), interstitial (every 5th detail-image view), rewarded (optional at wallpaper-set time). Rewarded eCPM often runs 10–30x banner; tying it to a "voluntary user action" captured the high yield without hurting UX.
