...
My hybrid model rule: ads should be present enough to motivate upgrades, not intrusive enough to cause uninstalls. Concretely: interstitial every 5 uses + persistent banner, both removed for subscribers. Full-screen interstitials after every action reliably destroy retention; banner-only doesn't motivate upgrades. I dig deeper into where ads and subscriptions start cannibalizing each other in [Rork App Revenue Design: Where Ads and Subscriptions Eat Each Other](/articles/rork-business/rork-app-monetization-complete-strategy).

## The Costs That Don't Show Up in the Estimate

Before talking about money coming in, it's worth listing the money going out. Shipping one app involves more than the Rork subscription — and on my first release plan, I nearly forgot to budget the Apple Developer Program fee.

<table>
<thead>
<tr><th>Item</th><th>Cost (at time of writing)</th><th>Notes</th></tr>
</thead>
<tbody>
<tr><td>Rork (React Native)</td><td>Free to $25/month</td><td>The free tier caps prompts per week; serious build-out effectively requires a paid plan</td></tr>
<tr><td>Rork Max (native Swift)</td><td>$200/month</td><td>The option if you want Apple Watch or Vision Pro reach. For the scope of this article, the React Native version is enough</td></tr>
<tr><td>Apple Developer Program</td><td>$99/year</td><td>Required for App Store submission. If it lapses, your app goes offline</td></tr>
<tr><td>RevenueCat</td><td>Free up to $2,500/month tracked revenue</td><td>Early-stage indie apps fit comfortably in the free tier</td></tr>
<tr><td>Supabase</td><td>Free tier available</td><td>Plan for a paid tier once image bandwidth grows</td></tr>
</tbody>
</table>

One cost that's easy to miss: credit consumption. Every time you change the spec and regenerate, credits burn. The "write the full spec first" approach I describe below saves money, not just rework.

Prices and plan terms change — verify against official sources before committing. For choosing between tiers, see [Rork Pricing Plans Compared Honestly: Free vs Pro vs Max and How to Choose as an Indie Developer](/articles/rork-basics/rork-pricing-plan-honest-comparison-2026).
...
Habit-building notifications outperform re-engagement notifications. "Your daily [X] is ready" converts better than "You haven't opened the app in 3 days." Weekly frequency is my balance point — frequent enough to maintain habit, not frequent enough to trigger uninstalls. For a fuller treatment of notification design and long-term retention, see [User Retention & LTV Maximization for Rork Apps](/articles/rork-business/rork-retention-ltv-maximization-guide).
