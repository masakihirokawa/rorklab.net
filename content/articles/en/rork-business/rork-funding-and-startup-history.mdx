...
<table>
  <thead>
    <tr><th>Platform</th><th>Strength</th><th>Main weakness</th></tr>
  </thead>
  <tbody>
    <tr><td>Rork</td><td>Native app generation accuracy; deep iOS focus</td><td>Weak on web app generation</td></tr>
    <tr><td>Bolt (StackBlitz)</td><td>Web app generation speed; WebContainer</td><td>Limited mobile support</td></tr>
    <tr><td>Lovable</td><td>Beautiful UI; beginner-friendly</td><td>Scaling issues for large apps</td></tr>
    <tr><td>FlutterFlow</td><td>Cross-platform; codebase-first</td><td>Less "AI-native" feel</td></tr>
    <tr><td>v0 (Vercel)</td><td>Vercel ecosystem; React component generation</td><td>Weak on business logic automation</td></tr>
  </tbody>
</table>
