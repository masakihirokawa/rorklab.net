...
<table>
  <thead>
    <tr><th>Lens</th><th>Ads</th><th>One-Time</th><th>Subscription</th></tr>
  </thead>
  <tbody>
    <tr><td>Works at a few thousand users?</td><td>Yes</td><td>Sometimes</td><td>Hard</td></tr>
    <tr><td>Plays well with Rork templates?</td><td>Setup hurdle (SDK)</td><td>Easiest</td><td>Easy</td></tr>
    <tr><td>Per-user revenue</td><td>Low</td><td>Medium</td><td>High</td></tr>
    <tr><td>Operational load</td><td>Medium (ad tuning)</td><td>Low</td><td>High (churn work)</td></tr>
    <tr><td>Damage if it fails</td><td>Small</td><td>Medium</td><td>Large (review backlash)</td></tr>
    <tr><td>Distance to ~$700/mo</td><td>A few thousand DAU</td><td>100–400 sales</td><td>50–200 active subs</td></tr>
  </tbody>
</table>
