...
From App Store Connect, navigate to `My Apps → [Your App] → App Store → Promotional Artwork`, where you can submit promotional materials. Additionally, members of the Apple Developer Program can submit feature nominations directly at [developer.apple.com](https://developer.apple.com/contact/app-store/promote/).
