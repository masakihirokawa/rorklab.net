...
If you're brand new to Rork, we recommend starting with "[Getting Started with Rork](/en/articles/rork-basics/getting-started)" to get familiar with the basics.
...
For a deeper dive into push notifications, check out "[Implementing Push Notifications in Rork](/en/articles/rork-dev/rork-push-notifications)."
...
Apps built with Rork can be submitted to the App Store and Google Play through Expo's build system. You'll need an Apple Developer Program membership ($99/year). For a walkthrough of the publishing process, see "[Build Your First App in 30 Minutes](/en/articles/rork-basics/rork-first-app-30-minutes-guide)."
