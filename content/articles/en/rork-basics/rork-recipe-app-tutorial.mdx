...
In this tutorial, we'll walk through building a full-featured recipe app from scratch using [Rork AI](/en/articles/rork-basics/what-is-rork). No coding experience is required — Rork's AI assistant handles the code generation so you can focus on design and functionality.
...
- A Rork account ([the free plan works to get started](/en/articles/rork-basics/rork-pricing-plans))
...
[New to Rork? Start with the getting started guide first](/en/articles/rork-basics/getting-started).
...
These subtle touches make an app feel polished and professional. [Learn more about animations in Rork here](/en/articles/rork-basics/rork-animations-guide).
...
Yes — recipes stored in AsyncStorage are available offline. If you configure image caching as well, users can browse their recipe collection without an internet connection. For a deeper dive into offline capabilities, check out the [Rork Offline Support Guide](/en/articles/rork-dev/rork-offline-support).

### Q3: Can I sync recipes across multiple devices?

Absolutely. By integrating Supabase or Firebase as a backend, you can sync recipe data across devices in real time. Rork supports both services out of the box. See the [Supabase & Firebase Backend Integration Guide](/en/articles/rork-dev/supabase-firebase-backend) for step-by-step instructions.

### Q4: How do I publish the app to the App Store?

Rork apps can be compiled into iOS and Android binaries using Expo EAS Build, then submitted through App Store Connect or Google Play Console. Follow the [App Store Publishing Guide](/en/articles/rork-basics/app-store-publishing) and [Google Play Publishing Guide](/en/articles/rork-basics/google-play-publishing) for detailed walkthroughs.
