...
<table>
  ...
  <tbody>
    <tr><td>Loading spinner for 2+ minutes</td><td>Network issue, server load, or request too complex</td></tr>
    <tr><td>"Something went wrong" error</td><td>Temporary service error</td></tr>
    <tr><td>Generation stops at ~50%</td><td>Context limit hit</td></tr>
    <tr><td>Generates something completely different</td><td>Prompt was too vague</td></tr>
    <tr><td>"Quota exceeded" message</td><td>Usage limit reached</td></tr>
  </tbody>
</table>
