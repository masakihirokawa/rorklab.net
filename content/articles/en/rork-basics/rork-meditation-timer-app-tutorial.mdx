...
If you're brand new to Rork, check out the "[Getting Started with Rork](/en/articles/rork-basics/getting-started)" guide first.
...
Yes, the core meditation timer app is entirely buildable on Rork's free tier. Keep in mind that the free plan has a limit of 5 generations per week, so plan your prompts carefully. If you need more iterations, take a look at [Rork's pricing plans](/en/articles/rork-basics/rork-pricing-plans) for options.
...
Apps built with Rork can be published to both the [App Store](/en/articles/rork-dev/app-store-publishing) and [Google Play](/en/articles/rork-dev/google-play-publishing). If you're on Rork Max, the 2-click App Store submission feature makes the process incredibly simple.
...
If you're ready to take your app's design to the next level, check out "[Design Techniques for Higher-Quality Rork Apps](/en/articles/rork-ai/rork-ai-design-premium-app-strategy)" for more advanced tips.
