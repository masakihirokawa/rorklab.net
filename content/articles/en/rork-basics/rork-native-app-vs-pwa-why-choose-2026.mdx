...
For a practical walkthrough of getting started, [Rork's getting started guide](/en/articles/rork-basics/getting-started) covers the basics. For a hands-on first project, [building your first app in 30 minutes](/en/articles/rork-basics/rork-first-app-30-minutes-guide) is a good place to start. For a deeper dive into the push notification setup, [push notifications with Rork](/en/articles/rork-dev/rork-push-notifications) goes further into the backend integration.
