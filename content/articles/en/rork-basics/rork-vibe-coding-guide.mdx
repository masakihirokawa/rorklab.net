...
With access to Apple-specific APIs like ARKit, Metal, HealthKit, and WidgetKit, Rork Max lets you build high-performance, platform-native experiences. For a detailed comparison, see [Rork vs. Rork Max](/articles/rork-basics/rork-vs-rork-max).
...
Start your vibe coding journey today at [Rork](https://rork.com) with the free plan. For more on the basics, check out [What Is Rork?](/articles/rork-basics/what-is-rork).
