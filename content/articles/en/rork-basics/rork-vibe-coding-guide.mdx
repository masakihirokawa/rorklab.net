...
Yes. Apps built with Rork can be published to both the App Store and Google Play. Rork integrates with Expo's build system, allowing you to submit builds directly from the dashboard. TestFlight beta testing is also supported. Check out the App Store Publishing Guide for details.
