...
## Why a Notes App Makes a Good First Build
...
The structure is simple, yet it packs in the fundamentals — saving, listing, searching. That combination makes a notes app an unusually good first project in **Rork**. Starting from an empty project, you'll end up with persistence through AsyncStorage and working search in a single app.
