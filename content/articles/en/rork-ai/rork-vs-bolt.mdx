...
A: Standard Rork generates cross-platform React Native apps for iOS and Android. Rork Max generates native Swift code and supports the entire Apple ecosystem, including Apple Watch, Apple TV, Vision Pro, and native-only APIs. See our [Rork vs Rork Max comparison](/articles/rork-basics/rork-vs-rork-max) for a full breakdown.
