...
| Task | Local M3 Ultra | AI Cloud | Speedup |
|---|---|---|---|
| Small SwiftUI view generation | 4.2 s | 1.1 s | 3.8x |
| Refactor proposal on existing code | 12.7 s | 3.9 s | 3.3x |
| Cross-file dependency analysis | 38.5 s | 8.2 s | 4.7x |
