...
<table>
  <thead>
    <tr><th>Tool</th><th>Plan</th><th>Monthly Cost (est.)</th></tr>
  </thead>
  <tbody>
    <tr><td>Rork Max</td><td>Pro or above</td><td>$39+</td></tr>
    <tr><td>Google Antigravity</td><td>Free (as of March 2026)</td><td>$0</td></tr>
    <tr><td>Google Stitch</td><td>Free (API limits apply)</td><td>$0+</td></tr>
    <tr><td>Apple Developer Program</td><td>Required for App Store</td><td>$99/year</td></tr>
  </tbody>
</table>
