...
**Important:** Rork Max is a separate product from the original Rork (React Native). It generates native SwiftUI code. Review the [Rork pricing guide](/en/articles/rork-basics/rork-pricing-plans) before getting started.
...
For more context, see our [Rork vs FlutterFlow comparison](/en/articles/rork-business/rork-vs-flutterflow) and the [Rork Max AI Features guide](/en/articles/rork-ai/rork-max-ai-features).
...
See the [Rork Max + Cloudflare AI Backend guide](/en/articles/rork-ai/rork-cloudflare-ai-backend) for the complete setup.
