...
I think of this as "build a bridge that's easy to repair when it breaks," not "build a bridge that won't break." Aiming for unbreakability is more expensive in the long run than designing for graceful repair. For a deeper dive into this mindset at any scale, [Site Reliability Engineering edited by Betsy Beyer](https://www.amazon.co.jp/dp/4873117917/?tag=pinocchio-22) is the canonical reference. It's written for Google-scale services, but the SLO/error-budget/postmortem mental models translate cleanly to indie operations.
