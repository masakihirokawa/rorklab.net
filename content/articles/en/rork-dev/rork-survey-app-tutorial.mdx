...
Here you build a fully functional survey app with Rork — multiple question types (single choice, multiple choice, and free text), responses saved to Supabase, and aggregated results drawn as a bar chart. It is written for beginners: you don't need deep React Native knowledge, just a basic familiarity with Rork's interface.
