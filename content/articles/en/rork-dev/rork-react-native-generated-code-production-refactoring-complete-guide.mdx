...
highlights:
  - "You can now identify the six technical debt patterns specific to Rork-generated code and eliminate them before shipping to production"
  - "You'll learn the three-stage refactoring workflow — TypeScript safety, component splitting, and state management — with complete Before/After code examples you can apply immediately"
  - "You'll be able to design a sustainable architecture that handles new features, growing teams, and scale without accumulating hidden debt over time"
---
