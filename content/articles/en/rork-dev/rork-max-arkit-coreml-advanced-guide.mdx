...
<table>
  <thead>
    <tr><th>Reason</th><th>Fix</th></tr>
  </thead>
  <tbody>
    <tr><td>"ARKit unstable"</td><td>Implement depth buffer timeout, fallback UI</td></tr>
    <tr><td>"Performance degradation"</td><td>Auto-fallback on frame drops</td></tr>
    <tr><td>"Privacy unclear"</td><td>Explicit NSCameraUsageDescription</td></tr>
    <tr><td>"Objects penetrating surfaces"</td><td>Implement physics-based collision detection</td></tr>
  </tbody>
</table>
