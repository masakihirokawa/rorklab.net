...
<table>
  <thead>
    <tr><th>Feature</th><th>Firebase Auth</th><th>Supabase Auth</th></tr>
  </thead>
  <tbody>
    <tr><td>Free tier</td><td>10,000 MAU/month</td><td>50,000 MAU/month</td></tr>
    <tr><td>Social login</td><td>◎ (Google, Apple, Twitter, etc.)</td><td>○ (major providers)</td></tr>
    <tr><td>Database</td><td>Firestore (NoSQL)</td><td>PostgreSQL (SQL)</td></tr>
    <tr><td>Open source</td><td>✗ (Google proprietary)</td><td>✓</td></tr>
    <tr><td>Learning curve</td><td>Medium</td><td>Low</td></tr>
    <tr><td>Rork compatibility</td><td>◎</td><td>◎</td></tr>
  </tbody>
</table>
