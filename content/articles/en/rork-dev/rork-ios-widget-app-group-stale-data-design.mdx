...
highlights:
  - "Rebuild the App Group + WidgetKit pipeline you've been stuck on, with code that compiles and refreshes today"
  - "Decide between shared UserDefaults and shared file system containers based on your app's actual data shape"
  - "Stop the 'widget is stuck on yesterday's value' bug from coming back by treating parent and widget as one state machine"
---
