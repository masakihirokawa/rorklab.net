...
|---|---|---|
| `fav:v` | Schema version | `"3"` |
| `fav:idx` | Sorted array of all IDs (JSON) | `["wp_8a", "wp_19", ...]` |
| `fav:ts:<id>` | Last-modified UNIX timestamp per favorite | `"1716879100"` |
| `fav:meta:<id>` | Optional metadata (category, tags) | JSON string |
| `fav:tomb:<id>` | Tombstone marker with TTL | `"1716879500"` |
