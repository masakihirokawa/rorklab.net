...
highlights:
  - "Developers who've been fixing the same UI bug across five separate apps can learn the SPM library pattern that cuts maintenance cost by 80% — with real before/after code"
  - "Learn how to extract and organize Rork Max-generated SwiftUI code into a Swift package with a theme injection system that keeps each app's brand identity while sharing core quality"
  - "Understand the architectural boundary between what belongs in the library and what stays in the app — the key decision that prevents SDK pollution and keeps your library clean"
---
