...
Rork Max uses a [cloud Mac fleet](/en/articles/rork-dev/rork-max-2-click-publish-complete-guide) for native compilation, so you don't need Xcode installed locally. Head to [rork.com/max](https://rork.com/max) and create a new project.
