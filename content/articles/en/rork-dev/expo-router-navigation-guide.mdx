---
title: "Navigation Design with Expo Router in Rork Apps: Tabs, Stacks, and Deep Links"
...
# Navigation Design with Expo Router in Rork Apps: Tabs, Stacks, and Deep Links
...
Expo Router gives Rork apps a clean, scalable navigation foundation. Understanding how file structure maps to routes — and how to communicate navigation intent clearly in your prompts — is the single biggest lever for improving the quality of your generated apps. The habit that finally saved me from the rebuild I mentioned at the start was sketching the directory structure on paper before adding any new screen.
