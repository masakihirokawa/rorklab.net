...
| Priority | Method | Accuracy | Setup cost | Scope |
|---|---|---|---|---|
| 1 | Apple Search Ads Attribution API / Google Play Install Referrer | 99% | Medium | iOS Search Ads / Google Play |
| 2 | SKAdNetwork 4.0 postbacks | 85–95% | High | All iOS 14.5+ ad inventory |
| 3 | Probabilistic fingerprint matching (Branch.io, Adjust, etc.) | 70–85% | Low (SDK) | Cross-platform |
| 4 | UTM parameters + clipboard | 20–40% | Low | Web → App fallback |
