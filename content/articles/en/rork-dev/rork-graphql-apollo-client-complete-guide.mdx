...
For a deep dive into authentication setup, check out our [Rork × Firebase/Supabase Authentication Guide](/articles/rork-dev/rork-auth-firebase-supabase).

To see GraphQL and Supabase working together in a real-time chat app, visit [Building a Supabase Chat App with Rork](/articles/rork-dev/rork-supabase-chat-app).

For managing app-wide state alongside Apollo's cache, the [Rork App State Management Patterns Guide](/articles/rork-dev/rork-advanced-state-management-patterns) pairs well with this article.
