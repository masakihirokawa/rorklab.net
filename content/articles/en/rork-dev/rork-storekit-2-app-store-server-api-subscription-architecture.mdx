...
<table>
  <thead>
    <tr><th><code>notificationType</code></th><th>Purpose</th><th>Urgency</th></tr>
  </thead>
  <tbody>
    <tr><td><code>SUBSCRIBED</code></td><td>New or resubscribed</td><td>High (grant entitlement)</td></tr>
    <tr><td><code>DID_RENEW</code></td><td>Auto-renewal success</td><td>Medium (extend expiry)</td></tr>
    <tr><td><code>DID_FAIL_TO_RENEW</code></td><td>Charge failed, in grace</td><td>High (show grace UI)</td></tr>
    <tr><td><code>EXPIRED</code></td><td>Subscription ended</td><td>High (revoke entitlement)</td></tr>
    <tr><td><code>REFUND</code></td><td>Refund finalized</td><td>Highest (revoke + audit log)</td></tr>
    <tr><td><code>DID_CHANGE_RENEWAL_STATUS</code></td><td>Auto-renew toggled</td><td>Low (cancellation notice UI)</td></tr>
    <tr><td><code>GRACE_PERIOD_EXPIRED</code></td><td>Grace period ended</td><td>High (revoke entitlement)</td></tr>
  </tbody>
</table>
...
<table>
  <thead>
    <tr><th>Operation</th><th>Client-only OK</th><th>Server required</th></tr>
  </thead>
  <tbody>
    <tr><td>Show premium UI</td><td>✅ (works offline)</td><td></td></tr>
    <tr><td>Run premium feature (local)</td><td>✅</td><td></td></tr>
    <tr><td>Run premium feature (cloud cost)</td><td></td><td>✅</td></tr>
    <tr><td>Finalize new purchase</td><td></td><td>✅</td></tr>
    <tr><td>Restore</td><td>✅ (optimistic display)</td><td>✅ (update canonical state)</td></tr>
    <tr><td>Cancellation UI</td><td>✅</td><td></td></tr>
  </tbody>
</table>
