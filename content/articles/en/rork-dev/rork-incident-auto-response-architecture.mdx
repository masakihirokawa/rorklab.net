...
<table>
  <thead>
    <tr><th>Layer</th><th>Primary signal</th><th>Secondary signal</th><th>Notification priority</th></tr>
  </thead>
  <tbody>
    <tr><td>Crash</td><td>Firebase Crashlytics</td><td>Sentry</td><td>Critical, immediate</td></tr>
    <tr><td>Functional</td><td>Sentry (errors + performance)</td><td>Firebase Performance</td><td>High, within 5 minutes</td></tr>
    <tr><td>Revenue</td><td>AdMob API + RevenueCat</td><td>Firebase Analytics</td><td>Medium, within 30 minutes</td></tr>
  </tbody>
</table>
