...
<table>
  <thead>
    <tr><th>Tool</th><th>Purpose</th><th>Output</th></tr>
  </thead>
  <tbody>
    <tr><td>Stitch</td><td>Requirements → Design direction exploration</td><td>Design.md (colors, typography, principles)</td></tr>
    <tr><td>Figma Make</td><td>Design.md → Implementation-ready UI</td><td>Figma file (all screens)</td></tr>
    <tr><td>Rork</td><td>Figma designs → Application code</td><td>React Native / Swift implementation</td></tr>
  </tbody>
</table>
