...
<table>
  ...
  <tbody>
    <tr><td>Total Beacons received</td><td>~482,000</td></tr>
    <tr><td>Silent-failure candidates extracted</td><td>712 (0.15% of total)</td></tr>
    <tr><td>Slack notifications (threshold-breaching only)</td><td>11</td></tr>
    <tr><td>Of those, real-impact incidents</td><td>4 (false-positive rate 64%)</td></tr>
    <tr><td>Estimated AdMob revenue impact</td><td>1.5 to 4% per incident recovered</td></tr>
  </tbody>
</table>
