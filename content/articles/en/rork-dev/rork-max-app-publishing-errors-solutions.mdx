...
<table>
  <thead>
    <tr><th>Rejection Reason</th><th>Common Cause</th><th>Solution</th></tr>
  </thead>
  <tbody>
    <tr><td>"Violates intellectual property rights"</td><td>Unauthorized use of copyrighted material</td><td>Verify asset licensing. Use royalty-free resources.</td></tr>
    <tr><td>"Apps that crash or exhibit bugs"</td><td>App crashes during testing</td><td>Thoroughly test on physical devices. Review crash logs.</td></tr>
    <tr><td>"Does not follow guidelines"</td><td>Non-standard UI or prohibited behavior</td><td>Review platform guidelines. Use standard UI components.</td></tr>
    <tr><td>"Incomplete app information"</td><td>Missing screenshots, descriptions, or other metadata</td><td>Complete all metadata fields in supported languages.</td></tr>
    <tr><td>"Not appropriate for audience"</td><td>Incorrect content rating</td><td>Set Content Ratings accurately.</td></tr>
    <tr><td>"Misleading description"</td><td>App description doesn't match implementation</td><td>Update description to match actual functionality.</td></tr>
  </tbody>
</table>
